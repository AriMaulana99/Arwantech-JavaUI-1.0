...
public class AlertWarning extends javax.swing.JDialog {
    ...
    public AlertWarning(java.awt.Frame parent, boolean modal, String text) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(138, 109, 59), 2));

        lblText.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        lblText.setForeground(new java.awt.Color(138, 109, 59));
        lblText.setText("Proses simpan data succsessfull");

        jLabel2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(209, 189, 154));
