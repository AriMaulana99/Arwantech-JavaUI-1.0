 ...
 * @author AriMaulana99
 */
public final class MessageWarning extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MessageWarning(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public MessageWarning(java.awt.Frame parent, boolean modal, String text) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/arwantech/javaui/images/warning.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessageWarning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MessageWarning dialog = new MessageWarning(new javax.swing.JFrame(), true);
