 ...
 * @author AriMaulana99
 */
public final class MessageInformation extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MessageInformation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public MessageInformation(java.awt.Frame parent, boolean modal, String text) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/arwantech/javaui/images/information.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessageInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MessageInformation dialog = new MessageInformation(new javax.swing.JFrame(), true);
