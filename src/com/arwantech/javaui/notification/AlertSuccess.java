...
public class AlertSuccess extends javax.swing.JDialog {
    ...
    public AlertSuccess(java.awt.Frame parent, boolean modal, String text) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(214, 233, 198));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(60, 118, 61), 2));

        lblText.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        lblText.setForeground(new java.awt.Color(60, 118, 61));
        lblText.setText("Proses simpan data succsessfull");

        jLabel2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(161, 185, 161));
