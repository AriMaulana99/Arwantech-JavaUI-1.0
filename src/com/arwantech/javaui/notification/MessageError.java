 ...
 * @author AriMaulana99
 */
public final class MessageError extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MessageError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public MessageError(java.awt.Frame parent, boolean modal, String text) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/arwantech/javaui/images/error.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MessageError dialog = new MessageError(new javax.swing.JFrame(), true);
