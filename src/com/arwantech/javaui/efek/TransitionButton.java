...
public class TransitionButton {
    ...
    public TransitionButton(JButton...buttons) {
        this.buttons = buttons;
        colorBorder = Color.decode("#BFBFBF");
        colorBorder = Color.decode("#BFBFBF");
        bgExited = Color.white;
    ...
    public void initTransition() {   
        ...
        for (final JButton button : buttons) {
                    ...
                    final TimerTask task = new TimerTask() {
                        ...
                        public void run() { 
                            try {
                                ...
                                button.setForeground(bgExited);
                                counter++;
                                if (counter == 20) {
                                    timer.cancel();
                                }
                            } catch (Exception e) {
                                button.setForeground(bgEntered); 
                            } 
                        }
                        };     
            ...
            public void mouseExited(MouseEvent evt) {
                ...
                try {
                    timer.cancel();
                    Color color = Color.decode(codeColorGradient.get(0));
                    button.setBackground(color);
                    button.setForeground(bgEntered); 
                } catch (Exception e) {
                    button.setForeground(bgEntered); 
