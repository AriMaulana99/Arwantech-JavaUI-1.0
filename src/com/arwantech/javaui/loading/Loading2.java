 ...
 * @author AriMaulana99
 */
public final class Loading2 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Loading2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/arwantech/javaui/images/loading2.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Loading2 dialog = new Loading2(new javax.swing.JFrame(), true);
